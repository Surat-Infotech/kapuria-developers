...
export const POST = {
  slug: "punjab-tricity-real-estate",
  title:
  ...
  metaTitle: "Punjab Tricity Real Estate | Kapuria Developers",
  metaDescription:
    "Chandigarh cannot grow outward, and that single fact drives the Tricity investment case. The published numbers, the catalysts still ahead, and where to buy.",
};

// Paragraphs that carry a citation are arrays of runs rather than strings —
// a plain string still works everywhere else.
export const SECTIONS = [
  {
    ...
    imageAlt: "The Tricity skyline at dusk, seen across low-rise rooftops",
  },
  {
    id: "land-scarcity",
    title: "The Engine That Can't Switch Off: Chandigarh's Land Scarcity",
    body: [
  ...
  {
    id: "the-numbers",
    title: "The Numbers, With Sources Attached",
    body: [
    ...
    richBlocks: [
      ...
      {
        title: "The rental story is the quiet outperformer",
        body: [
      ...
      {
        title: "And the market is maturing, not overheating",
        body: [
  ...
  {
    id: "catalysts-ahead",
    title: "The Catalysts Still Ahead",
    body: [
    ...
    richBlocks: [
      ...
      {
        title: "The airport corridor, already delivering",
        body: [
      ...
      {
        title: "Roads unknotting the value zones",
        body: [
  ...
  {
    id: "where-to-invest",
    title: "Where to Invest: A Pocket-by-Pocket Playbook",
    richBlocks: [
      {
        title: "Mohali — the core holding",
        body: [
      ...
      {
        title: "Aerocity / Airport Road — the flagship",
        body: [
      ...
      {
        title: "Zirakpur — the yield-and-value play",
        body: [
      ...
      {
        title: "New Chandigarh — the decade bet",
        body: [
  ...
  {
    id: "due-diligence",
    title: "Investing Smart: The Due Diligence That Protects Your Returns",
    body: [
