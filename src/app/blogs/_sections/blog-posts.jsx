...
const PostCard = ({ image, titleLead, titleRest, excerpt, meta, href }) => (
  <article className="flex flex-col items-start gap-18">
    <Link
      href={href}
    ...
    <div className="flex w-full flex-col items-start gap-8 sm:gap-16">
      <div className="flex w-full flex-col items-start gap-8">
        <h3 className="text-navy-800 text-[16px]/[24px] font-semibold">
          <Link
            href={href}
    ...
    >
      <div className="flex flex-col items-start justify-between gap-8 sm:flex-row sm:items-start sm:gap-16 md:gap-24">
        <div className="flex flex-col items-start gap-8 sm:gap-16">
          ...
          <p className="text-navy-800/60 max-w-871 text-[14px]/[22px] font-medium sm:text-[16px]/[24px]">
        ...
        <div className="flex shrink-0 flex-col items-start sm:items-end">
          <p className="text-navy-800/60 text-[14px]/[34px] font-normal tracking-[3.04px] uppercase sm:text-[16px]/[34px]">
            Todays Date
          </p>
          <p className="text-navy-800 text-[18px] font-medium sm:text-[22px]">
            {TODAYS_DATE}
          </p>
        </div>
      </div>
      <div className="relative mt-16 flex flex-col items-center gap-24 pt-16 sm:mt-32 sm:gap-36 md:mt-64">
        ...
        <div className="flex w-full flex-col items-start justify-between gap-24 sm:flex-row sm:items-end">
          <div className="flex flex-col items-start gap-8">
            <h2 className="text-navy-800 text-[26px]/[34px] font-semibold sm:text-[36px]/[44px]">
              Blog Posts
            </h2>
            <p className="text-navy-800/60 text-[14px]/[22px] font-medium sm:text-[16px]/[24px]">
          ...
          <button
            type="button"
            className="text-navy-800 hover:text-gold-400 focus-visible:ring-gold-400 flex cursor-pointer items-center gap-8 rounded-sm text-[16px]/[26px] font-semibold tracking-[3.42px] uppercase transition-colors duration-200 focus-visible:ring-2 focus-visible:outline-none sm:text-[18px]/[26px]"
          >
            Sort by
        ...
        <button
          type="button"
          className="text-navy-800/60 hover:text-navy-800 focus-visible:ring-gold-400 flex cursor-pointer items-center gap-8 rounded-sm text-[16px] font-semibold tracking-[3.42px] uppercase transition-colors duration-200 focus-visible:ring-2 focus-visible:outline-none sm:text-[18px]"
        >
          View more
